...
- **Leadership scope**: Only at Citeck (team of up to 4 frontend engineers). GymTeam = sole engineer (no team). iRecommend = senior IC, equal partner. Do not imply leadership elsewhere.
- **Bonusway browser extension**: Single extension (not multiple), supporting Chrome, Opera, and Yandex. Do not write "extensions" (plural).
