...
date: 2026-06-05
description: "Event loop почти всегда попадает в список тем для повторения. Разбираем call stack, браузерные API, очереди задач и типичные проблемы."
tags: ["JavaScript"]
lang: ru
urlSlug: event-loop
draft: false
...
Вот задача, которая встречается почти на каждом техническом собесе. Посмотрите на код и скажите, что и в каком порядке выведет консоль.
