...
date: 2026-06-12
description: "Продолжаю серию про базовые вопросы для подготовки к собесам. После event loop и замыканий следующая тема — хойстинг. Спрашивают реже, но ответ «переменные поднимаются» слишком слабый. Разберём, как оно работает под капотом."
tags: ["JavaScript"]
lang: ru
