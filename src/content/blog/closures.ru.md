...
date: 2026-06-09
description: "Продолжаю разбирать базовые вопросы для подготовки к собесам. После event loop следующая тема из обязательной программы — это замыкания, спрашивают очень часто."
tags: ["JavaScript"]
lang: ru
urlSlug: closures
draft: false
