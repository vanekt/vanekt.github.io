...
export const en: Translations = {
  ...
  meta: {
    ...
    description:
      "Senior Frontend & Full Stack Engineer with 15 years building products teams actually ship. React, Vue, TypeScript, Node.js, Go. Open to remote.",
  },
  nav: {
    about: "About",
  ...
  about: {
    title: "About",
    paragraphs: [
      "Senior Full Stack Engineer with 15 years at startups and enterprise companies. Deep expertise in React, Vue, and TypeScript; strong experience in Node.js, Go, PHP, and React Native. Built web applications and mobile products end-to-end; led a frontend team of up to 5 engineers.",
