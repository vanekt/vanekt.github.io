...
export const ru: Translations = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "Способен реализовать всё, что связано с фронтендом: веб-приложения любой сложности, библиотеки, виджеты, расширения для браузеров, кроссплатформенные мобильные приложения.",
      "Значительный опыт в разработке бэкенда и настройке серверов.",
    ],
  },
  experience: {
    title: "Опыт работы",
