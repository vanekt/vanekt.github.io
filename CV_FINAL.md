# CV Final — Ivan Tkachenko

> Final version based on CV_DRAFT.md. No placeholders remain.
> Jump to: [English](#english) · [Russian](#russian)
...
Buenos Aires, Argentina (UTC-3) · Remote
GitHub: github.com/vanekt · Telegram: t.me/vanekt0 · LinkedIn: linkedin.com/in/-ivan-tkachenko-/
...
- Migrated components with full support for dark/light theming, 6 locales, and responsive breakpoints
...
- Migrated the platform to Next.js SSR, improving search indexability and cutting initial load time
- Built several Go + PostgreSQL API endpoints on own initiative, expanding beyond the primary frontend role
...
Senior Full Stack Engineer
Буэнос-Айрес, Аргентина (UTC-3) · Удалённо
GitHub: github.com/vanekt · Telegram: t.me/vanekt0 · LinkedIn: linkedin.com/in/-ivan-tkachenko-/
...
- Переносил компоненты с поддержкой тёмной/светлой темы, 6 языков (i18n) и адаптивных брейкпоинтов
...
- Перевёл платформу на SSR с Next.js: улучшил индексируемость в поиске и сократил время первой загрузки
- По собственной инициативе реализовал несколько API-эндпоинтов на Go + PostgreSQL, расширив зону ответственности за пределы основной фронтенд-роли
- Выстроил UI/UX дизайн-систему с нуля совместно с 2 дизайнерами и продактом: дизайн-токены, компонентные спецификации и реализация, принятые всей веб-платформой
...
- Создал protobuf-компиляторы для Go, PHP и JavaScript, компрессор шрифтов и генераторы кода на Go/TypeScript: многошаговый ручной boilerplate превратился в одну команду
